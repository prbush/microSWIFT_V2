              ...
              emxArray_int8_T *a2, emxArray_int8_T *b2, emxArray_uint8_T *check)
{
  ...
  if ((east->size[0] >= 5120) && (fs >= 1.0)) {
    ...
    if (nx < 100) {
      ...
      pts = (int)floor(4.0 * ((double)pts / win - 1.0) + 1.0);
      ...
      if (((int)win == uwindow->size[0]) && (x->size[1] == uwindow->size[1])) {
        i = taper->size[0] * taper->size[1];
      ...
      if (((int)win == vwindow->size[0]) && (x->size[1] == vwindow->size[1])) {
        i = taper->size[0] * taper->size[1];
        taper->size[0] = (int)win;
        taper->size[1] = x->size[1];
        emxEnsureCapacity_real_T(taper, i);
      ...
      if (((int)win == wwindow->size[0]) && (x->size[1] == wwindow->size[1])) {
        i = taper->size[0] * taper->size[1];
        taper->size[0] = (int)win;
        taper->size[1] = x->size[1];
        emxEnsureCapacity_real_T(taper, i);
      ...
      for (mi = 0; mi < i; mi++) {
        ...
        b_UUwindow->size[1] = UUwindow->size[1];
        ...
        i3 = b_UUwindow->size[0] * b_UUwindow->size[1];
        b_UUwindow->size[0] = b_loop_ub;
        b_UUwindow->size[1] = VVwindow->size[1];
        emxEnsureCapacity_real32_T(b_UUwindow, i3);
        east_data = b_UUwindow->data;
        for (i3 = 0; i3 < vlen; i3++) {
          for (i5 = 0; i5 < b_loop_ub; i5++) {
        ...
        i3 = b_UUwindow->size[0] * b_UUwindow->size[1];
        b_UUwindow->size[0] = b_loop_ub;
        b_UUwindow->size[1] = WWwindow->size[1];
        emxEnsureCapacity_real32_T(b_UUwindow, i3);
        east_data = b_UUwindow->data;
        for (i3 = 0; i3 < nx; i3++) {
          for (i5 = 0; i5 < b_loop_ub; i5++) {
        ...
        b_UVwindow->size[1] = UVwindow->size[1];
        ...
        i3 = b_UVwindow->size[0] * b_UVwindow->size[1];
        b_UVwindow->size[0] = b_loop_ub;
        b_UVwindow->size[1] = UWwindow->size[1];
        emxEnsureCapacity_creal32_T(b_UVwindow, i3);
        Uwindow_data = b_UVwindow->data;
        for (i3 = 0; i3 < b_i; i3++) {
          for (i5 = 0; i5 < b_loop_ub; i5++) {
        ...
        i3 = b_UVwindow->size[0] * b_UVwindow->size[1];
        b_UVwindow->size[0] = b_loop_ub;
        b_UVwindow->size[1] = VWwindow->size[1];
        emxEnsureCapacity_creal32_T(b_UVwindow, i3);
        Uwindow_data = b_UVwindow->data;
        for (i3 = 0; i3 < k; i3++) {
          for (i5 = 0; i5 < b_loop_ub; i5++) {
      ...
      if ((UU->size[1] == b_E->size[1]) && (i == b_y->size[1])) {
        loop_ub = UU->size[1] - 1;
        i = UU->size[0] * UU->size[1];
        UU->size[0] = 1;
        emxEnsureCapacity_real_T(UU, i);
